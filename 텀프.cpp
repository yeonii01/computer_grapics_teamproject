...
GLvoid drawScene() //--- 콜백 함수: 그리기 콜백 함수 
{
	...
	gluSphere(wbody, 1.0, 50, 50); //눈사람 몸통
	TR = glm::mat4(1.0f);
	...
	glUniform3f(vColorLocation, 0.5f, 0.5f, 0.9f);
	gluQuadricDrawStyle(wbody, GLU_FILL);
	gluSphere(whead, 0.75, 50, 50); //눈사람 머리
	...
	//1. saveroad[0] + 0번째 부분의 x축 scale의 반값  + 1번째 부분의 z축 scale반값  - 90도
